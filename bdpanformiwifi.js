...
(function (){
    ...
    var helperMenuBtns=(function(){
        var menuTitleArr=['\u76f4\u63a5\u4e0b\u8f7d','\u5c0f\u7c73\u8def\u7531','\u67e5\u770b\u94fe\u63a5'],panBtnsArr=[],html='';
    ...
    function copyText(text){
        var _src = window.location.href;  //下载来源网页
        var startofname = text.indexOf("&zipname=")    /*提取地址中以zipname为起始的文件名*/
        var _name = text.substring(startofname + 9)       
        var mi = "https://d.miwifi.com/d2r/?url=" + Base64.encodeURI(text) + "&src=" + encodeURIComponent(_src) + "&name=" + _name;
        window.open(mi);
    }
